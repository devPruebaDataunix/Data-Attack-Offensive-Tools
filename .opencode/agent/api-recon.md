...
programa aportó identidades de prueba, confirma que están en `identities[]` (referenciadas). Devuelve
al Orquestador la lista de endpoints priorizados para explotación diferencial.
