...
- `<details><summary>` para listas largas (los 19 agentes de E2, la aprobación por riesgo),
...
**bus A2A mediado**, 29 agentes, blackboard, scope guard, RAG KEV+EPSS, bot). El wordmark de la
