...
Da "frescura" al corpus: 0-days/exploits/writeups recientes. Fuentes confirmadas:
...
def main():
    ...
    ap.add_argument("--no-hn", action="store_true", help="omite Hacker News (solo 0dayfans)")
