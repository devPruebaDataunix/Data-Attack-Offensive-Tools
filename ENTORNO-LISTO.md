...
| **Agents** | 29 especialistas: 19 de fase + 10 de herramienta (metasploit, recon-suite, nuclei, web-fuzzing, sqlmap, netexec, sliver, ad-enum, kerberos, adcs) | auto-descubiertos |
